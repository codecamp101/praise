...
const wordsmith = [
    ...
    {
        word: "PARIS",
        hint: "country of the Eiffel Tower",
        offset: [1,3],   
    },
    {
        word: "NEWYORK",
        hint: "has the staute of Lady Liberty",
        offset: [2,4],
    },
    {
        word :"MONALISA",
        hint :"the most famous painting",
        offset: [1,5,8],
    },
    {
        word : "QATAR",
        hint : "hosted the 2022 World Cup final",
        offset : [1,3,5],
    },
    {
        word : "REALMADRID",
        hint : "lost to arsenal in 2025",
        offset : [2,4,6],
    }
];
